				...
				<div class="about">
					...
					<div class="form-group">
					  <div class="input-group col-sm-9 ">
							...
							<div class="form-group col-sm-10">
							   <div class="col-sm-4">
							   		<select class="form-control" id="charges" name="charges" required >
            							<option value="">Select</option>
            							<option value="free">Free</option>
            							<option value="300">300 (8 Day's)</option>
            							<option value="600">600 (15 Day's)</option>
            							<option value="1200">1200 (1 Month)</option>
            							<option value="1800">1800 (1.5 Month)</option>
            							<option value="2400">2400 (2 Month)</option>
            							<option value="3000">3000 (2.5 Month)</option>
            							<option value="3600">3600 (3 Month)</option>
						  			</select>
						  		</div>
							</div>
						</div>
