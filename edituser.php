<?php
	...
	$userId = $_GET['id'];
	$row = mysql_fetch_assoc(mysql_query("select * from users where user_id='".$userId."'"));
	...
	<body>
		<!---start-wrap---->
			...
			<div class="content">
				<div class="wrap">
				<div class="about">
					<div class="title"><h3>Add User</h3></title>
					<form class="form-horizontal" role="form" id="patientdata" action = "adduser_process.php" method="POST">
						...
						<label class="control-label col-sm-2" for="symtom">Name:</label>
						  <div class="col-sm-4">
							<input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="<?php echo $row['name']?>">
						  </div>
						<!-- <div class="col-sm-4">  -->
						...
						<div class=" form-group"> 
						  ...
						  <div class="col-sm-4">
							<input type="text" class="form-control" name="contactno" id="contact" placeholder="Enter Contact No." value="<?php echo $row['contact_no']?>">
						  </div>
						</div>
					  </div>
					...
					<div class="form-group">
					  <div class=" form-group"> 
						  ...
						  <div class="col-sm-4">
								...
								$selected = '';
								while($row1 = mysql_fetch_array($getbranches)){
								    if($row['branch_code'] == $row1['branch_code']) {
								        $selected = "selected";    
								    }
