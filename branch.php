...
<li class="active"><a href="branch.php">Branches</a></li>
			...
			<div class="content">
				...
				<div class="title"><h3>	Users</h3></title>
					...
					<?php
						$getallbranch = mysql_query("select * from branches");
						$i = 1;
						while($row = mysql_fetch_array($getallbranch)){
							echo "<tr>";
							echo "<td>".$i;
							echo "</td>";
							...
							echo "<td><a href='editbranch.php?branchId=".$row['branch_id']."'>Edit</a>&nbsp;||&nbsp;";
							
							echo "<a href='delete.php?id=".$row['branch_id']."&type=b'>Delete</a></td></tr>";							$i++;
						}
					?>
					</tbody>
					</table>
