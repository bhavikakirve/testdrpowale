<?php
	...
	$eid = $_REQUEST['eid'];
	$getpatientdata = mysql_query("select pd.pid, epd.charges, epd.branch_id, epd.created_on, epd.created_by, pd.reference,pd.patient_name, pd.patient_id, pd.gender, pd.date_of_birth, pd.contact_no, pd.place, pd.chief_complain, pd.past_history, pd.family_history, u.name, epd.patsymtoms, epd.disease, pd.age from ed_patient_diagnosis epd, patient_details pd, users u where epd.patient_id = pd.patient_id and epd.created_by= u.user_id and epd.ed_id='".$eid."'");
			...
			<div class="content">
				...
				<div class="about">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
					  	  <label class="control-label col-sm-2" for="symtom">Reference:</label>	
					  	  <div class="col-sm-2">
							<?php echo $reference;?>
						  </div>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
						...
						<div class="col-sm-12" >
						  ...
						  <div class=" form-group"> 
							  <label class="control-label col-sm-3" for="remedy">Prognosis:</label>
							  <div class="col-sm-9">
								<?php echo $prognosis; ?>
							  </div>
						  </div>
...
if(!empty($mobno)) // phone number is not empty
{
	...
	if($area_code!='NP') {
	    $msg="NCONNECT HOMOEOPATHY, Dear $patient_name received Rs $charges/-. Call: ".$doctorNo."Specialities: Piles,Allergies,Hairfall,Spondylitis, Backache";
	} else {
...
$url="http://sms.mdsmedia.in/http-api.php?username=powale&password=pass1234&senderid=POWALE&route=1&number=$mobno&message=$messageFinal";
