		...
		<!---start-wrap---->
			...
			<div class="content">
				...
				<div class="about">
					...
					<form class="form-horizontal" role="form" id="patientdata" action = "patient_process.php" method="POST" data-toggle='validator'>
					  ...
					  <div class="form-group">
						...
						<div class=" form-group"> 
						  ...
						  <div class="col-sm-4">
							<input type="text" class="form-control" VALUE="91" style="width:15%;float:left;">&nbsp;&nbsp;<input type="text" class="form-control" name="contactno" id="contact" placeholder="Enter Patient Contact No." maxlength=10 style="width:80%;float:left;margin-left:6px;">
						  </div>
						</div>
					  </div>
						...
						<div class="col-sm-12" >
						  ...
						  <div class=" form-group"> 
							  ...
							  <div class="col-sm-10" >
								<div class="checkboxes" >
									  ...
									  <label class=" col-sm-3"><input type="checkbox" name="blood_transfusion"  value="1">Blood Transfusion</label><br/><br/>
									 <div class=" col-sm-12">
						  ...
						  <div class=" form-group"> 
							  ...
							  <div class="form-group col-sm-10" >
								...
								<div class="col-sm-4 "><input type="text" class=" form-control" name="indigestible_things" placeholder="Indigestible Things"></div>
							  ...
							  <div class="form-group col-sm-10" >
								...
								<div class="col-sm-4 ">
									<input type="text" class=" form-control" name="habits" placeholder="Habits">
								</div>
  ...
  $("#diagnosbtn").click(function(){	  
		...
		$("input[name='symtoms[]']").each(function() {
			if($(this).val().length > 0){
				...
				diagnosed = diagnosed+"<br/>"+$(this).val()+"<br/>";
			}
		});
		//alert(multi_members);
		$.ajax({
